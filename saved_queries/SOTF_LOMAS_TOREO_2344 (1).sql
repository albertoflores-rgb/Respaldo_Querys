...
DROP TABLE IF EXISTS wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_2344;

CREATE TABLE wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_2344 AS
...
--SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_4547;
--SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_1584;
--SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_1770;
SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_2344;
--SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_3845;
