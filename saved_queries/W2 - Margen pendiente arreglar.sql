...
DROP TABLE IF EXISTS wmt-edw-sandbox.Black_Bird.MARGEN_INICIAL_SOSTENIDO_AUTOSERVICIO_A0f07dn_TMP1;

CREATE TABLE wmt-edw-sandbox.Black_Bird.MARGEN_INICIAL_SOSTENIDO_AUTOSERVICIO_A0f07dn_TMP1 AS
