...
DROP TABLE IF EXISTS wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_1584;

CREATE TABLE wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_1584 AS
...
--SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_3845;
--SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_3845;
SELECT * FROM wmt-edw-sandbox.Black_Bird.REPORTE_VENTAS_SOFT_SC_2382
