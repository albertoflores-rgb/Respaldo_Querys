...
Select
   ...
   -- COALESCE(SUM(CASE WHEN (Right (CAST(a.WM_YR_WK AS STRING),2) = "01") THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_WK01,
    ...
    --Ventas por Mes------------------------------------------------------------------------------------------------------
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 1) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M01,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 2) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M02,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 3) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M03,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 4) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M04,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 5) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M05,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 6) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M06,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 7) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M07,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 8) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M08,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 9) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M09,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 10) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M10,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 11) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M11,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 12) THEN (a.sat_qty * d.sat_mult + a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult + a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult +a. fri_qty * d.fri_mult) END),0) AS    Venta_Pzas_M12,
...
--Venta Piezas Mensual Año Pasdao-------------------------------
    ...
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 1) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M01,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 2) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M02,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 3) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M03,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 4) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M04,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 5) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M05,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 6) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M06,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 7) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M07,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 8) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M08,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 9) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M09,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 10) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M10,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 11) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M11,
    COALESCE(SUM(CASE WHEN (EXTRACT(MONTH FROM d.gregorian_date) = 12) THEN ((a.sat_qty * d.sat_mult +a.sun_qty * d.sun_mult +a.mon_qty * d.mon_mult + a.tue_qty * d.tue_mult +a.wed_qty * d.wed_mult + a.thu_qty * d.thu_mult + a.fri_qty * d.fri_mult) * a.sell_price) END),0) AS VENTA_PESOS_M12,
...
INNER JOIN wmt-edw-sandbox.WM_AD_HOC_MX.SUPPLY_CHAIN_DB i ON (b.old_nbr = i.old_nbr AND a.store_nbr = i.store_nbr and I.FECHA_ACT = '2025-12-30')
